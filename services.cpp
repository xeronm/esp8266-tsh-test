...
{
	ASSERT_EQ(svcctl_start(hmdb), SVCS_ERR_SUCCESS);
	ASSERT_EQ(svcctl_start(hmdb), SVCS_ALREADY_RUN);
...
svcs_errcode_t _on_start(imdb_hndlr_t hmdb, imdb_hndlr_t hdata, dtlv_ctx_t* conf) { return SVCS_ERR_SUCCESS; }
